...
@bot.message_handler(func= lambda message: storage.get_current_state(message.from_user.id, "VOCAB") or 999 == States.VOCAB_START_QUIZ)
...
@bot.message_handler(func= lambda message: storage.get_current_state(message.from_user.id, "VOCAB") or 0 > 0 )
